...
class Base:
    ...
    def __init__(self, trace_paths: List[str], trace_config: Dict, 
                 car_config: Dict, sensors_configs: Optional[List[Dict]] = [], 
                 task_config: Optional[Dict] = dict(), logging_level: Optional[str] = 'WARNING'):
        ...
        for sensor_config in sensors_configs:
            ...
            if sensor_type == 'camera':
                ...
                raise NotImplementedError('Unrecognized sensor type {}'.format(sensor_type))
