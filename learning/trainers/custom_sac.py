...
CustomSACTrainer = GenericOffPolicyTrainer.with_updates(
    name="SAC",
...
CustomSACTrainer._allow_unknown_subkeys.append('Q_model')
CustomSACTrainer._allow_unknown_subkeys.append('policy_model')