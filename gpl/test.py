...
def main():
    ...
    parser.add_argument('--trace-paths', type=str, nargs='+', required=True,
    ...
    if args.out_dir is None:
        args.out_dir = os.path.join(os.path.dirname(os.path.dirname(args.ckpt)), 
            'results', args.ckpt.split('/')[-1].split('.')[0])
